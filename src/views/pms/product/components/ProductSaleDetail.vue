  ...
  <div style="margin-top:50px">
    ...
    >
      ...
      <el-form-item v-show="value.promotionType===2">
        <div v-for="(item,index) in value.memberPriceList" :class="{litteMargin:index!==0}">
        ...
        <el-table :data="value.productLadderList" style="width:80%" border>
          ...
          <el-table-column align="center" label="操作">
            <template slot-scope="scope">
              ...
              <el-button type="text" @click="handleAddProdctLabber(scope.$index,scope.row)">添加</el-button>
            </template>
          </el-table-column>
        </el-table>
      </el-form-item>
      ...
      <el-form-item style="text-align:center">
        ...
        <el-button size="medium" @click="handleNext">下一步</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    handleRemoveProductLabber(index, row) {
      let productLabberList = this.value.productLadderList;
      if (productLabberList.length === 1) {
        productLabberList.pop();
        productLabberList.push({
          count: 0,
          discount: 0,
          price: 0
        });
      } else {
        productLabberList.splice(index, 1);
      }
    },
    handleAddProductLabber(index, row) {
      let productLabberList = this.value.productLabberList;
      if (productLabberList.length < 3) {
        productLabberList.push({
          count: 0,
          discount: 0,
          price: 0
    ...
    handleReomoveFullReduction(index, row) {
